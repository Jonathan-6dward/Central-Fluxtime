  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-white/10 pb-6">
        <div>
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-xs font-bold text-blue-400 tracking-widest uppercase">Automation Pipeline</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">FlowNews AI</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative">
         ...
         <div className="hidden lg:block absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-blue-500/20 via-primary/20 to-green-500/20 -z-10 -translate-y-1/2"></div>
         ...
         {/* Step 2: Processing */}
         <div className="glassmorphism p-6 rounded-xl border border-primary/20 bg-[#111815] relative">
            <div className="absolute top-1/2 -right-3 w-6 h-6 bg-[#111815] border border-white/10 rounded-full flex items-center justify-center z-10 hidden lg:flex">
               <ArrowRight size={12} className="text-gray-500" />
            </div>
            <div className="flex items-center gap-3 mb-6">
               <div className="p-2 bg-primary/10 rounded-lg text-primary"><BrainCircuit size={20} /></div>
            ...
            <div className="space-y-4">
               ...
               <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="flex items-center gap-2 text-primary font-bold text-xs bg-primary/10 px-2 py-1 rounded">
                     <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></div> Processando
                  </span>
               </div>
            </div>
         </div>
         ...
         <div className="glassmorphism p-6 rounded-xl border border-green-500/20 bg-[#111815]">
            ...
            <div className="space-y-3">
               ...
               <div className="p-3 bg-white/5 rounded-lg border border-white/5 flex items-center justify-between">
                  <span className="text-sm text-gray-300">Creator Studio Draft</span>
            ...
            {[1, 2, 3, 4].map((i) => (
               <div key={i} className="flex items-center justify-between p-4 border-b border-white/5 hover:bg-white/5 transition-colors">
                  <div className="flex items-center gap-4">
                     <div className={`p-2 rounded bg-white/5 ${i === 2 ? 'text-yellow-400' : 'text-primary'}`}>
